    ...
    <footer className="w-full border-t bg-white py-6 dark:bg-card">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-2 text-muted-foreground">
              ...
              <p className="flex items-center gap-2">
                ...
                <a
                  href="mailto:naf@nationalagro.org"
          ...
          <div className="flex flex-col items-end text-right">
            ...
            <p className="text-muted-foreground max-w-xs">
              National Agro Foundation is dedicated to bringing prosperity to
              rural India through scientific agriculture and sustainable
              development.
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 text-center text-xs text-muted-foreground">
          <p>
            Copyright ©2024-25 All rights reserved. National Agro Foundation
          </p>
        </div>
      </div>
    </footer>
